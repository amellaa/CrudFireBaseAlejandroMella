        ...
        holder.editar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (adapterPosition != RecyclerView.NO_POSITION) {
                    ...
                    if (contentView != null) {
                        EditText nombre = contentView.findViewById(R.id.nombreText);
                        EditText apellido = contentView.findViewById(R.id.apellidoText);
                        EditText email = contentView.findViewById(R.id.emailText);
